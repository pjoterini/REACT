...
class EntityAssigner {
    ...
    static assign(entity, data, options = {}) {
        ...
        Object.keys(data).forEach(prop => {
            ...
            if (props[prop] && Utils_1.Utils.isCollection(entity[prop])) {
            ...
            if ([enums_1.ReferenceType.MANY_TO_ONE, enums_1.ReferenceType.ONE_TO_ONE].includes(props[prop]?.reference) && value != null) {
