...
export declare class EntityManager<D extends IDatabaseDriver = IDatabaseDriver> {
     ...
     */
    refresh<T extends object, P extends string = never>(entity: T, options?: FindOneOptions<T, P>): Promise<T | null>;
    /**
     ...
     */
    upsert<T extends object>(entityNameOrEntity: EntityName<T> | T, data?: EntityData<T> | T, options?: NativeInsertUpdateOptions<T>): Promise<T>;
    /**
